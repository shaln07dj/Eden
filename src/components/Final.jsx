...
const Final = () => {
  ...
  const [active, setActive] = useState(
    siteInfo.siteInfo.info.welcome.welcomeActive
  );
  const [visited, setVisited] = useState(
    siteInfo.siteInfo.info.welcome.welcomeVisited
  );
      ...
      <div className={styles.container}>
        <div className={styles.topBar}>
          <div className={styles.topBarBold}>
            <div className={styles.topBarBoldContent}></div>
          </div>
          <div className={styles.topBarContent}></div>
        </div>
